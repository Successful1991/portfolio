...
// ------ add controller -----
  ...
  var shar1 = addShar(900, 60, 'app/img/planet_Bog.jpg', 0, 0, -4000);
  var shar2 = addShar(900, 60, 'app/img/Venus2.jpg', -4000, 0, 4000);
  var shar3 = addShar(720, 50, 'app/img/planet_Quom.jpg', 4000, 0, 4000);
  ...
  function comet(obj, spead) {
          if (obj.position.z >= -14000 && obj.position.z <= 18000) {
            obj.position.z += spead;
          } else {
            obj.position.z = -14000;
          }
        }
